...
fila=recorrido[-1]
ind=ciudades.index(origen)
print('Distancia de ultima a primera:')
print(distancias[fila][ind])
kmacum= kmacum + distancias[fila][ind]
rr,cc, val= draw.line_aa(coordenadas[fila][0],coordenadas[fila][1],coordenadas[ind][0],coordenadas[ind][1])
img[rr,cc] = 1
recorrido.append(ind)
print('El recorrido es:')
print(recorrido)
print('Km realizados:')
print(kmacum)
print('Ciudades Recorridas')
city=[]
for i in range(0,len(recorrido)):
    city.append(ciudades[recorrido[i]])
print(city)
io.imshow(img)
io.show()
